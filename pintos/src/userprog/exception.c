...
//      if(!(is_user_vaddr((int32_t)fault_addr) && (int32_t)esp - (int32_t)fault_addr <= 32
//       && 0xC0000000UL - (int32_t)fault_addr <= 8 * 1024 * 1024)){
//      //if(!verify_stack((int32_t)fault_addr, esp){
//         sys_exit(-1);
//      }
...
// //       vm_supt_install_zeropage (curr->supt, fault_page);
// //   }
//    // handle_mm_fault(virtualmemory entry)
